...
export default function SearchBar() {
  ...
  return (
    <div className={`flex items-center relative w-2/5 rounded-xl border border-stone-300 bg-white px-4 py-2.5 shadow-sm outline-none transition focus-within:border-violet-300 focus-within:ring-2 focus-within:ring-violet-100`}>
      <input
        type="text"
        value={searchText}
      ...
      <div className="absolute right-2 top-1/2 -translate-y-1/2"> {/* New div to position IconButton */}
        <IconButton
          icon={Funnel}
